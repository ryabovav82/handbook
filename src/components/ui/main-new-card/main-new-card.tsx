...
export const MainNewCardUI: FC<ICardProps> = ({ id, menuItemId, serialNumber, image, text }) => {
  ...
  return (
    <div>
      {isOpen ? (
        <div className={styles.main_cards_card} key={id} onClick={handleCreateNewCard}>
      <div className={styles.main_cards_card_img}>
         <img className={styles.main_base_card_img} src={editedImage} alt={`card-${id}`} />
        {isAuthenticated && (
          <input
      ...
      {isAuthenticated && (
        <div className={styles.main_base_card_buttons}>
          <button className={styles.main_base_card_button_save} onClick={handleSave}>
            Save
          </button>
          <button className={styles.main_base_card_button} onClick={handleDelete}>
            Delete
          </button>
        </div>
      )}
